...
(function () {
  ...
  function select() {
    ...
    console.log("checkValidHand(): ", currentHand, currentScore, currentSuit, isPoker);
    let handIsHigher = (boardHand === undefined || isPoker || currentHand == boardHand) && (currentScore > boardScore || (currentScore == boardScore && currentSuit > boardHighSuit));              
    console.log("handIsHigher:", handIsHigher)
    let allowMove = playerCanChoose &&
                    selected.size != 0 &&
  ...
  function makeMove() {
    ...
    [boardHand, boardScore, boardHighSuit] = [currentHand, currentScore, currentSuit];
